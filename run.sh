...
do
    ...
    #-------------------------------------------------------------#
    # multi-step PGD AT
    # CUDA_VISIBLE_DEVICES=$device python -u train_adv.py --autoattack --randomseed $seed --datasets $datasets --lr 0.1 --train_eps $eps --test_eps $eps  --wd 0.0005 --arch=$model --epochs=200  --save-dir=pgd10_save_seed$seed\_$model\_$datasets\_eps$eps |& tee -a pgd10_seed$seed\_log_$model\_$datasets\_$eps
    
    # multi-step PGD Sub-AT
    # CUDA_VISIBLE_DEVICES=$device python -u train_adv_psgd.py --autoattack  --datasets $datasets --lr 1  --train_eps $eps --test_eps $eps  --params_start 0 --params_end 200  --batch-size 128  --n_components 120 --arch=$model --epochs=40  --save-dir=pgd10_save_seed$seed\_$model\_$datasets\_eps$eps |& tee -a pgd10_seed$seed\_log_$model\_$datasets\_$eps\_psgd
